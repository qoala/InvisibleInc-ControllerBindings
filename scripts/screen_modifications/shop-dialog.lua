...
local function modifyWidget(widgetIndex, modification)
    ...
    return {"shop-dialog.lua", {"widgets", widgetIndex}, modification}
end
local function modifySubWidget(widgetIndex, childIndex, modification)
    assert(type(modification) == "table", type(modification))
    return {"shop-dialog.lua", {"widgets", widgetIndex, "children", childIndex}, modification}
end
            ...
            "shop-dialog.lua", {
                {
                    ...
                    children = sutil.concat(
                            sutil.widgetRow(
                                    1, "upperInv.item1", "upperInv.item2", "upperInv.item3",
                                    "upperInv.item4", "upperInv.item5", "upperInv.item6",
                                    "upperInv.item7", "upperInv.item8"), --
                            sutil.widgetRow(
                                    2, "lowerInv.item1", "lowerInv.item2", "lowerInv.item3",
                                    "lowerInv.item4", "lowerInv.item5", "lowerInv.item6",
                                    "lowerInv.item7", "lowerInv.item8")),
                ...
                },
                {
                    ...
                    children = sutil.concat(
                            sutil.widgetCol(
                                    1, "shop.aug1", "shop.aug2", "shop.aug3", "shop.aug4"),
                            sutil.widgetCol(
                                    2, "shop.weap1", "shop.weap2", "shop.weap3", "shop.weap4"),
                            sutil.widgetCol(
                                    3, "shop.item1", "shop.item2", "shop.item3", "shop.item4"),
                            sutil.widgetCol(
                                    4, "shop.item5", "shop.item6", "shop.item7", "shop.item8")),
                    recallOrthogonalX = true,
                },
                {
                    id = "bottom",
