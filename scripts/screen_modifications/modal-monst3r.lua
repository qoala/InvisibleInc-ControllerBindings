...
local function modifyWidget(childIndex, modification)
    return {"modal-monst3r.lua", {"widgets", 2, "children", childIndex}, modification}
end
            ...
            "modal-monst3r.lua", {
                ...
                },
                {
                    ...
                    children = sutil.widgetList(
                            "cycleStashLeftBtn", "stashItem1", "stashItem2", "stashItem3",
                            "stashItem4", "stashItem5", "stashItem6", "stashItem7", "stashItem8",
                            "cycleStashRightBtn"),
