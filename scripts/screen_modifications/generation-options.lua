...
local function modifyWidget(childIndex, modification)
    return {"generation-options.lua", {"widgets", 7, "children", childIndex}, modification}
end
...
local function modifyNamedWidget(childName, modification)
    return {"generation-options.lua", {"widgets", 7}, {inheritDef = {[childName] = modification}}}
end

local function modifySkin(skinIndex, modification)
    return {"generation-options.lua", {"skins", skinIndex}, modification}
end
local function modifySkinWidget(skinIndex, childIndex, modification)
    return {"generation-options.lua", {"skins", skinIndex, "children", childIndex}, modification}
end
            ...
            "generation-options.lua", {
                {
                    ...
                    children = sutil.widgetList(
                            ...
                            -- Advanced
                            "difficulty4", "difficulty5", "difficulty6", "difficulty7",
                            "difficulty8", --
                            -- DLC + Mods
